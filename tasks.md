...
- The view update has no new portable release archive yet. The published 2.0.1 archives still contain the older view. Package a patch release if distributing this update beyond the Mac mini.
