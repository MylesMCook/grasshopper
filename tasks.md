...
- Eight Markdown files remain: one formatted README, one SETUP.md, two required AGENTS.md files, connector SKILL.md, operator and verification docs, and this task record. The vulnerability-reporting contact now lives in the README. The root AGENTS.md user's edit remains unstaged.
