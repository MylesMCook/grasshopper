...
The memory view and [How it works](/about/) page link to each other. Their light/dark switch shares only a display preference in this browser; it never stores the access token.
