...
This is **unpublished 2.2.0 candidate evidence** against a task-local server and synthetic data. The live private service and real agent settings were untouched.
