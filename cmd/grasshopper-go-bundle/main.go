...
func addFile(writer *zip.Writer, file input, sums *strings.Builder) error {
	...
	// Staged templates stay private on disk. Archive entries are public package
	// files and must remain readable after a root-owned system installation.
...
func run() error {
	...
	flag.StringVar(&version, "plugin-version", "2.3.3", "client plugin version")
